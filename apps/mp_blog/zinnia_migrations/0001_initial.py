    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_template', models.CharField(default=b'zinnia/_entry_detail.html', help_text="Template used to display the entry's content.", max_length=250, verbose_name='content template', choices=[(b'zinnia/_entry_detail.html', 'Default template')])),
                ('detail_template', models.CharField(default=b'entry_detail.html', help_text="Template used to display the entry's detail page.", max_length=250, verbose_name='detail template', choices=[(b'entry_detail.html', 'Default template')])),
            ],
            options={
        ...
        migrations.AddField(
            model_name='entry',
            name='categories',
            field=models.ManyToManyField(related_name='entries', verbose_name='categories', to='zinnia.Category', blank=True),
        ),
        migrations.AddField(
            model_name='entry',
            name='related',
            field=models.ManyToManyField(related_name='_entry_related_+', verbose_name='related entries', to='zinnia.Entry', blank=True),
        ),
        migrations.AddField(
            model_name='entry',
            name='sites',
            field=models.ManyToManyField(help_text='Sites where the entry will be published.', related_name='entries', verbose_name='sites', to='sites.Site'),
        ),
